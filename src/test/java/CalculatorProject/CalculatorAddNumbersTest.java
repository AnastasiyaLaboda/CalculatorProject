...
public class CalculatorAddNumbersTest {
    ...
    public void addNumbersSumPositiveIntegers(int number1, int number2, double result) {
        assertEquals(result, Calculator.addNumbers(number1, number2),
                "Expected result " + result + ", but actual " + Calculator.addNumbers(number1, number2) + " for numbers " + number1 + " and " + number2);
    }
