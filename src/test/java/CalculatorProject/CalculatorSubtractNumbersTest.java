...
public class CalculatorSubtractNumbersTest {
    ...
    public void subtractNumbersPositiveIntegers(int number1, int number2, double result) {
        assertEquals(result, Calculator.subtractNumbers(number1, number2),
                "Expected result " + result + ", but actual " + Calculator.subtractNumbers(number1, number2) + " for numbers " + number1 + " and " + number2);
    }
